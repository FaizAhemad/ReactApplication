...
export const formVariables = {
  ...
  WE_WILL_NEVER_SHARE_YOUR_EMAIL_WITH_ANYONE_ELSE:
...
export const checkForAdminAccount =
  'http://localhost:5000/api/admin/checkForAdminAccount';

export const fetchcategories =
  'http://localhost:5000/api/categories/fetchcategories';
...
export const goToHome = (pathname = '', navigate = () => {}) =>
  !(pathname === '/home' || pathname === '/') && navigate('/home');
